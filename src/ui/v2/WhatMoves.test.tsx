...
describe('WhatMoves — sensitivity tornado + insights', () => {
  ...
  it('leads with the biggest lever and shows the how-to-read key', () => {
    ...
    expect(screen.getByText(/Right bar/i)).toBeInTheDocument()
    expect(screen.getByText(/Left bar/i)).toBeInTheDocument()
    expect(screen.getByText(/percentage points of success/i)).toBeInTheDocument()
  })
})
